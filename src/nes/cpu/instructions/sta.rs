...
mod test {
  ...
  fn test_sta() {
    ...
    // BROKEN test_instruction!("STA", IndirectY, [0x02, 0x04, 0x00, 0x00, 0x00]{a: 0x66, y:1} => [0x02, 0x04, 0x00, 0x00, 0x66]{});
    // BROKEN test_instruction!("STA", AbsoluteX, [0x03, 0x00]{a:0x66, x:1} => [0x03, 0x00, 0x00, 0x66]{});
    // BROKEN test_instruction!("STA", AbsoluteY, [0x03, 0x00]{a:0x66, y:1} => [0x03, 0x00, 0x00, 0x66]{});
  }
}
